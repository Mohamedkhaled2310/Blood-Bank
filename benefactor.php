...
if ($count_query != 0 && $diff->m < 3) {
    ...
    $query = mysqli_query($con, "INSERT INTO `poll`(`id`, `name`, `national_id`, `phone`,`t_blood`,`address`,`is_sick`,`date`,`call_time`,`t_cuminication`,`order_date`) VALUES ('','$name','$national_id','$num','$blood','$address','$check','$date','$call_time' ,'$check2',CURDATE())");
    if($query){
        $_SESSION['status'] = "تم";
    ...
    <div class="w3layouts_main wrap">
        <h3 style=" margin-bottom: 6px; margin-top: 6px; font-size:95%;"><span style="color: #c71919; font-weight: bold;">*</span> الرجاء مساعدتنا في تحديد فصيلتك  </h3>
            ...
            <input  required oninvalid="this.setCustomValidity('الرجاء كتابة الاسم رباعي ')"
                    oninput="this.setCustomValidity('')" type="text" placeholder="..." name="name" value="<?php if(isset($_SESSION['national_id'])){echo $_SESSION['name'];}?>" <?php if(isset($_SESSION['national_id'])){echo "disabled";}?>/>
            ...
            <input maxlength="14" minlength="14" required oninvalid="this.setCustomValidity('الرجاء كتابة الرقم القومي ')"
                   oninput="this.setCustomValidity('')" type="number"  placeholder="..."  name="national_id" value="<?php if(isset($_SESSION['national_id'])){echo $_SESSION['national_id'];}?>"/>
            ...
            <input required oninvalid="this.setCustomValidity('الرجاء كتابة العنوان ')"
                   oninput="this.setCustomValidity('')" type="text" placeholder="..." name="address"><br>
            ...
            outline: none;
            margin: 5px;
            border-radius: 5px; " type="date" placeholder="mm-dd-yyyy" name="date" id="date"> <br>
            ...
            <input required oninvalid="this.setCustomValidity('الرجاء كتابة الرقم صحيح ')"
                   oninput="this.setCustomValidity('')" type="tel" minlength="11" maxlength="11" placeholder="... " name="num"/>
            ...
            <input required oninvalid="this.setCustomValidity('الرجاء كتاية موعد الاتصال بك ')"
                   oninput="this.setCustomValidity('')"type="text" placeholder="... " name="call_time"><br>
            ...
            <br>
            <br>
            <center><input type="submit" value="ارسال" class="agileinfo" name="submit"></center>
        </form>
